...
def get_feishu_auth_url(state: str) -> str:
    ...
    """
    scopes = "offline_access minutes:minutes:update minutes:minutes.artifacts:read minutes:minutes.basic:read minutes:minutes.media:export minutes:minutes.search:read minutes:minutes.statistics:read minutes:minutes.transcript:export minutes:minutes.upload:write vc:meeting vc:meeting:readonly"
