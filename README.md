...
1. **安全设置 (Security Settings)**：
   - 找到 **“安全设置”**，在 **“重定向 URL (Redirect URL)”** 输入框中添加：
     ...
     *(注：该回调路径同时用于支持“用户账号一键快捷登录”和登录后的“飞书账号绑定”流程)*
